...
import com.skynet.javafx.utilities.config.PropertiesConfig;
import com.skynet.javafx.utilities.jfxsupport.FXMLController;
import com.skynet.javafx.services.FrameService;
import com.skynet.javafx.services.MenuItemService;
...
public class MainController {
	...
	TreeView<com.skynet.javafx.models.MenuItem> treeView;
	...
	private void initialize() {
		...
		if (config.getJavafxMainTree()) {
			com.skynet.javafx.models.MenuItem rootMenuItem = menuItemService.getMenuItemRoot();
			TreeItem<com.skynet.javafx.models.MenuItem> rootNode = new TreeItem<>();
	...
	public void onWindowShownEvent() {
		if (treeView != null) {
			MultipleSelectionModel<TreeItem<com.skynet.javafx.models.MenuItem>> msm = treeView.getSelectionModel();
	...
	private void buildTreeItems(TreeItem<com.skynet.javafx.models.MenuItem> parentNode) {
		Long parentId = -1l;
		if (parentNode.getValue() != null) {
			parentId = parentNode.getValue().getId();
		}
		List<com.skynet.javafx.models.MenuItem> menuItems = menuItemService.getMenuItemsByParent(parentId);
		for (com.skynet.javafx.models.MenuItem item : menuItems) {
			TreeItem<com.skynet.javafx.models.MenuItem> itemNode = new TreeItem<>();
	...
	private void onSelectItemAction(TreeView<com.skynet.javafx.models.MenuItem> treeView) {
		TreeItem<com.skynet.javafx.models.MenuItem> item = treeView.getSelectionModel().getSelectedItem();
		if (item == null)
			return;
	...
	private void showItemContent(com.skynet.javafx.models.MenuItem menuItem) {
	...
	private ToolBar buildToolBar() {
		...
		List<com.skynet.javafx.models.MenuItem> menuItems = menuItemService.getMenuItemsByParent(0l);
		for (com.skynet.javafx.models.MenuItem item : menuItems) {
	...
	private void onToolBarButtonAction(com.skynet.javafx.models.MenuItem item) {
